...
** The Creature class represents a Creature Base Class for the batmanGame. This class is
...
/*********************************************************************
** Function: Creature::get_defPoints()
** Description: Getter for returning the Creature defense points
** Parameters:	N/A
** Pre-Conditions: N/A
...
/*********************************************************************
** Function: Creature::pain(int, int)
** Description: Default function to determine total pain inflicted
** Parameters:	attack		Result of the attack roll or manual input
**				defense		Result of the defense roll or manual input
** Pre-Conditions: N/A
** Post-Conditions: Returns an int from the pain calculation.
*********************************************************************/
...
/*********************************************************************
** Function: Creature::add_inventory(string, string, int, bool)
** Description: Pass through function to add Item to the Utility Belt
** Parameters:	iName		Item name
**				uName		Item description
**				qInput		Item quantity
**				special		If item is special/required for the Game
** Pre-Conditions: N/A
** Post-Conditions: Stores the Item into Creatures Utility Belt
*********************************************************************/
...
/*********************************************************************
** Function: Creature::remove_inventory()
** Description: Pass through function to remove Item from the Belt
** Parameters:	N/A
** Pre-Conditions: N/A
** Post-Conditions: Removes the Item from Creatures Utility Belt
*********************************************************************/
...
/*********************************************************************
** Function: Creature::transfer_qty(string, Creature)
** Description: Pass through function to remove Item from Villain Belt
**				and add Item to Batman's Utility Belt
** Parameters:	iName		Item name
**				batman		Pass in Batman so Item is added to his Belt
** Pre-Conditions: N/A
** Post-Conditions: Stores the Item into Batman's Utility Belt
*********************************************************************/
void Creature::transfer_qty(std::string iName, Creature* batman)
{
	...
	Item tempItem;
	// If Item is found in the Villain's Belt
	if (search_items(iName)) {
		...
		// Add the Item to Batman's Utility Belt if there is room. Returns whether it was added or not
		itemAdded = batman->uBelt->addItems(tempItem.get_itemName(), tempItem.get_itemDesc(), 1, tempItem.get_special());
		
		// If item is added, remove it from the Villain's Belt
		if (itemAdded)
...
/*********************************************************************
** Function: Creature::get_itemName()
** Description: Pass through function to print Items in the Utility Belt
** Parameters:	N/A
** Pre-Conditions: N/A
** Post-Conditions: Prints the Items in the Creatures Utility Belt
*********************************************************************/
...
/*********************************************************************
** Function: Creature::search_items(string)
** Description: Pass through function to search Items in the  Belt
** Parameters:	N/A
** Pre-Conditions: N/A
** Post-Conditions: Returns true if Item is in the Creature's Utility
**					Belt
*********************************************************************/
