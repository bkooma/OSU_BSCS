...
** a vector object to initialize the menu. The SafeInput is used to ensure the user
...
/*********************************************************************
** Function:		userMenu::clearMenu()
** Description:		Clear the menu vector for reuse.
** Parameters:
** Pre-Conditions:	N/A
** Post-Conditions: Menu vector is empty.
*********************************************************************/
void userMenu::clearMenu()
{
	choice.clear();
}
