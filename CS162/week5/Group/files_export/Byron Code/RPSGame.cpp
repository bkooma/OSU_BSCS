...
** Parameters:		The strength of each tool, set to 1 unless the user chooses to input their own
...
** Description:		This function takes a user input choice of Tool type and creates the
					cooresponding Tool type for the human to play in the current round
** Parameters:		User input Tool type, case insensitive.
					The strength of each tool, set to 1 unless the user chooses to input their own
...
** Description:		This function executes a round of the RPS game and handles the result of the round.
** Parameters:		N/A
** Pre-Conditions: 	human and computer members must contain a Tool object
** Post-Conditions: The round is played and the appropriate scoreboard member is incremented
*********************************************************************/
...
/*********************************************************************
** Function: 		RPSGame::printScore
** Description:		This function prints a formated output of the scoreboard memebers to the console.
** Parameters:		N/A
** Pre-Conditions: 	N/A
** Post-Conditions: N/A
*********************************************************************/
